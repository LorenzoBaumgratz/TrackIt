...
export default function Task(props) {
    ...
    return (
        <Conteudo data-test="habit-container">
            ...
            <Week>
                <button data-test="habit-day" disabled={(props.hab.days.includes(1)?true:false)}>D</button>
                <button data-test="habit-day" disabled={(props.hab.days.includes(2)?true:false)}>S</button>
                <button data-test="habit-day" disabled={(props.hab.days.includes(3)?true:false)}>T</button>
                <button data-test="habit-day" disabled={(props.hab.days.includes(4)?true:false)}>Q</button>
                <button data-test="habit-day" disabled={(props.hab.days.includes(5)?true:false)}>Q</button>
                <button data-test="habit-day" disabled={(props.hab.days.includes(6)?true:false)}>S</button>
                <button data-test="habit-day" disabled={(props.hab.days.includes(7)?true:false)}>S</button>
            </Week>
        </Conteudo>
    )
}
